        ...
        <div className="flex items-center justify-between gap-4">
            ...
            <div>
                ...
                <div className="flex flex-wrap items-center gap-2">{tags.map((label, key) => (
                    <span key={key} className="grid items-center h-8 px-3 text-sm rounded-lg text-zinc-400 bg-zinc-50/5 ">{label}</span>
                ))}
                </div>
            </div>

            <div className="grid bg-white rounded-lg w-11 h-11 place-items-center text-zinc-950 shrink-0">
